...
export default function App() {
  ...
  const translations: any = {
    es: {
      ...
      legalTitle: 'Información Legal, Términos y Condiciones de Uso (Servidor NewAra Pro)',
      usoAcademico: 'Uso Académico y Propósito Pedagógico',
      usoAcademicoDesc: 'NewAra es una plataforma de apoyo y simulación pedagógica destinada exclusivamente a fines de estudio personal. Los resultados de los cuestionarios, exámenes de práctica y minijuegos sirven como referencia formativa y de autoevaluación; no garantizan una calificación aprobatoria en evaluaciones académicas oficiales ni sustituyen el plan curricular formal de tu institución educativa.',
      privacidad: 'Privacidad de Datos y Almacenamiento Local',
      privacidadDesc: 'Respetamos profundamente tu privacidad. Las configuraciones de diseño (incluyendo la selección de temas de color y estados de navegación), respuestas a minijuegos en curso y demás preferencias del lado del cliente se guardan localmente en el almacenamiento de tu navegador (localStorage). El sistema no recopila información personal no autorizada.',
      cuentasUsuario: 'Registro de Cuentas y Responsabilidad de Seguridad',
      cuentasUsuarioDesc: 'A partir de la versión RELEASE 2.1, el registro e inicio de sesión de usuario es de carácter obligatorio para poder publicar contenidos, actividades, minijuegos y participar activamente del chat. Tu contraseña se cifra de manera segura. Eres el único responsable de mantener la confidencialidad de tus credenciales de acceso para evitar cualquier uso desautorizado de tu cuenta.',
      integridadAcademica: 'Política de Integridad Académica y Responsabilidad',
      integridadAcademicaDesc: 'NewAra promueve un aprendizaje ético, honesto y colaborativo. No nos responsabilizamos, bajo ninguna circunstancia, por conductas deshonestas, copia o trampas realizadas por estudiantes en exámenes oficiales utilizando esta herramienta formativa.',
    ...
    en: {
      ...
      legalTitle: 'Legal Information, Terms and Conditions of Use (NewAra Pro Server)',
      usoAcademico: 'Academic Use & Educational Purpose',
      usoAcademicoDesc: 'NewAra is an educational support and practice platform intended solely for personal study. Results from quizzes, mock exams, and minigames serve as formative feedback and self-assessment references; they do not guarantee official passing grades on real exams or replace the curriculum of your educational institution.',
      privacidad: 'Data Privacy & Local Storage',
      privacidadDesc: 'We value your privacy. Visual settings (such as theme color selection and active view status), active minigame sessions, and other client-side preferences are stored locally in your browser storage (localStorage). The system does not collect unauthorized personal data.',
      cuentasUsuario: 'Account Registration & Security',
      cuentasUsuarioDesc: 'As of RELEASE 2.1, registering and logging into an authorized account is required to publish content, create activities, post in classrooms, and chat. Passwords are securely hashed. You are solely responsible for keeping your login credentials confidential to avoid unauthorized account access.',
      integridadAcademica: 'Academic Integrity Policy & Disclaimer',
      integridadAcademicaDesc: 'NewAra drives honest, cooperative learning. We disclaim all liability or responsibility for unauthorized academic shortcuts, misconduct, plagiarism, or cheating on official exams committed by users in connection with the platform.',
    ...
    ru: {
      ...
      legalTitle: 'Юридическая информация, правила и условия использования (Сервер NewAra Pro)',
      usoAcademico: 'Академическое использование и образовательные цели',
      usoAcademicoDesc: 'NewAra — это вспомогательная образовательная платформа, предназначенная исключительно для индивидуального обучения. Результаты тестов, симуляций и мини-игр служат ориентиром для самоконтроля; они не гарантируют получение официальных оценок на реальных экзаменах и не заменяют учебный план учебного заведения.',
      privacidad: 'Конфиденциальность данных и локальное хранилище',
      privacidadDesc: 'Мы уважаем вашу конфиденциальность. Индивидуальные настройки (такие как цветовая тема и статус отображения), сеансы мини-игр и другие предпочтения сохраняются локально в вашем браузере (localStorage). Минимально необходимые данные обрабатываются безопасно.',
      cuentasUsuario: 'Регистрация учетных записей и ответственность за безопасность',
      cuentasUsuarioDesc: 'Начиная с версии RELEASE 2.1, регистрация и вход необходимы для публикации учебных материалов, общих мини-игр и общения в чате. Пароли шифруются локально. Вы несете полную личную ответственность за конфиденциальность ваших учетных данных для предотвращения несанкционированного доступа к вашему аккаунту.',
      integridadAcademica: 'Политика академической честности и отказ от ответственности',
      integridadAcademicaDesc: 'NewAra поддерживает честное обучение. Мы не несем ответственности за использование платформы для списывания, мошенничества или обхода правил во время официального тестирования. Пользователь обязан соблюдать этику учебы.',
