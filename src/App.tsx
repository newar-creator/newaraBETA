...
export default function App() {
  ...
  const [showReportModal, setShowReportModal] = useState<{id: string, name: string, creatorName?: string} | null>(null);
              ...
              <AeroCard className="max-h-[90vh] overflow-y-auto border-t-white/80 border-l-white/60 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)]" theme={theme}>
                <div className="space-y-6 relative z-10 pb-4 pt-2">
                  ...
                  <ExerciseRunner 
                    ...
                    theme={theme}
                    onReport={activeExercise.subjectId === 'shared' ? () => setShowReportModal({id: activeExercise.id, name: activeExercise.name || 'Actividad', creatorName: activeExercise.creatorName}) : undefined}
                  />
                </div>
              </AeroCard>
            </motion.div>
