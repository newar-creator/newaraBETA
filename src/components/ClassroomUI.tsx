...
export const ClassDetail: React.FC<ClassDetailProps> = ({ 
  ...
  onPostAnnouncement, onPostComment, onShareResource, onPlayActivity, onCreateAssignment, onSubmitTask, onBack, onArchive, onLeave, userName 
}) => {
              ...
              <div className="space-y-4">
                {announcements.length === 0 ? (
                  ...
                  announcements.map((ann) => (
                    <AeroCard key={ann.id} theme={theme} className="p-4 md:p-6">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] opacity-40 font-bold">{ann.createdAt?.toDate().toLocaleDateString()}</p>
                        </div>
                      </div>
